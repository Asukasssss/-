...
最新来源核对：服务器连接已恢复，作者映射为 37 肿瘤、39 正常标本；159 条冻结特征全部找到，73 条显著特征的 KEGG/HMDB 与作者原注释一致，身份暂挂仍保留。974 条候选中 935 条两端均有 37 个有限值，36 条 RNA 符号未匹配，3 条基因符号未解析。患者独立性未确认，关联尚未运行。详见 `results/COAD/03_PATIENT/20260919T114909Z_source_readiness_v2/README_CN.md`。
...
- 作者原注释来源、标本对应和精确 RNA 符号覆盖已核对；患者独立单位、配对与协变量仍需核查。服务器连接已恢复。
