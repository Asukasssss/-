# 最新：LYPLA1高低组KEGG富集已完成

[KEGG完整报告](../../results/COAD/06_EXTERNAL/20260925T155303Z_lypla1_kegg_v1/README_CN.md)：沿用8供者、2,528细胞的原差异统计，P<0.05且|log2FC|≥0.25选择158高、276低基因，不使用FDR筛选。官方人类KEGG 372通路中312项可评估；主背景ORA有26个方向—通路组合P<0.05，注释背景敏感性25项；GSEA有50项P<0.05（21偏高、29偏低）。脂肪消化吸收、PPAR信号、醚脂代谢GSEA分别P=0.01229、0.01610、0.04753，均偏LYPLA1低组；其ORA均未过P<0.05。磷脂酰肌醇信号下调ORA P=0.03917，注释背景P=0.03788，但GSEA未显著。4项官方脂代谢通路因受检成员不足15而不可评估，完整去向保留。无新增患者或差异表达检验；不将富集当成LYPLA1因果调控。原Reactome与CAMP结果保留。

# LYPLA1效应门槛改为|log2FC|≥0.25

[更新报告](../../results/COAD/06_EXTERNAL/20260925T153907Z_lypla1_fc025_v3/README_CN.md)：沿用8位供者的LYPLA1阳性CNA上皮高低分组及原效应/P，按用户新门槛采用P<0.05且|log2FC|≥0.25，不用FDR筛选。434个基因入选，高组较高158个、较低276个；比0.5历史版增加303个。重新计算差异基因ORA，38项原始P<0.05；胆汁酸代谢、IP3/IP4合成和血浆脂蛋白相关命中主要来自高组较低基因。全排序GSEA不受门槛变化影响，复用234项P<0.05。主清单中67项在深度模型仍同向P<0.05，需保留深度混杂限制；不是LYPLA1干预或代谢机制证明。未新增差异检验或GSEA，历史版本保留。

# LYPLA1高低表达差异与通路（原始P、0.5门槛历史版）已完成

[LYPLA1高低组报告](../../results/COAD/06_EXTERNAL/20260925T152822Z_lypla1_highlow_nominal_v2/README_CN.md)：按用户明确要求，不用FDR筛选。8位供者的LYPLA1阳性CNA上皮2,528细胞按供者内中位数分高低，检验11,058基因。945项P<0.05，另加|log2FC|≥0.5后高组较高39项、较低92项。Reactome差异基因ORA有35项原始P<0.05；全基因GSEA有234项原始P<0.05，二者不相加。18项主候选在深度模型仍同方向P<0.05。通路命中基因逐项提供，很多条目共享少数基因；本批是探索性共表达，不能当作LYPLA1因果机制。源数据、逐供者/细胞值与旧q留服务器；新图和正文只展示P。

# ASNS整体上皮对比已完成

[ASNS整体细胞对比](../../results/COAD/06_EXTERNAL/20260925T144645Z_asns_cell_pooled_v1/README_CN.md)：沿用同一批CNA/CNN/正常参照上皮，细胞数4,477/7,885/16,138。平均log1p(CP10K)为0.2185/0.0859/0.0792，检出比例23.2%/7.6%/6.5%；CNA整体较高，CNN与正常参照数值接近。仅检出细胞均值0.9425/1.1286/1.2166，CNA并不更高；整体差异主要伴随检出比例增加。属于细胞等权描述，无新P/q或ASNS患者层面推断；数值接近不是等效性证明，CNN不能称为已证实非恶性。

# SLC6A6整体上皮对比已完成

[SLC6A6整体细胞对比](../../results/COAD/06_EXTERNAL/20260925T143700Z_slc6a6_cell_pooled_v1/README_CN.md)：与UCKL1、LYPLA1沿用同一批CNA/CNN/正常参照上皮，细胞数4,477/7,885/16,138。平均log1p(CP10K)为0.2864/0.0491/0.0131，检出比例29.1%/4.2%/约1.0%；仅检出细胞均值0.9825/1.1615/1.3260，CNA并不更高。整体差异主要伴随检出比例增加；正常参照检出很少，均值倍数需结合低基线阅读。属于细胞等权描述，无新P/q或SLC6A6患者层面推断，CNN不能称为已证实非恶性。

# LYPLA1整体上皮对比已完成

[LYPLA1整体细胞对比](../../results/COAD/06_EXTERNAL/20260925T142407Z_lypla1_cell_pooled_v1/README_CN.md)：沿用UCKL1同一批CNA/CNN/正常参照上皮，细胞数4,477/7,885/16,138。平均log1p(CP10K)为0.6901/0.3583/0.2649，检出比例56.9%/29.0%/21.2%；仅检出细胞均值1.2120/1.2341/1.2519接近，整体差异主要伴随检出比例增加。属于细胞等权描述，没有新增P/q或LYPLA1患者层面推断，CNN不能称为已证实非恶性。

# UCKL1整体细胞等权展示已补充

[整体细胞对比](../../results/COAD/06_EXTERNAL/20260925T141710Z_uckl1_cell_pooled_v1/README_CN.md)：按用户要求将相同三组细胞分别合并展示。CNA/CNN/正常参照的UCKL1检出比例为37.0%/15.7%/18.0%，平均log1p(CP10K)为0.3638/0.1890/0.2347。CNA组整体较高主要伴随检出比例增加，仅在检出细胞中平均表达并不更高。此为细胞等权描述，无新P/q；CNN不等于已证实非恶性，患者结果保留。
