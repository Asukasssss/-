...
**读表更正：**[来源状态修正版](../results/BRCA/07_INTEGRATION/20260922T120000Z_source_display_v2/README_CN.md)已发布。CYP4F2等不可评估项显示“暂不可定位”；原图和机械排名保留但不构成可靠定位。SHMT2的共同类别排名是ER+髓系、HER2+/TNBC恶性上皮，不是三组一致。以下图册未重算。
